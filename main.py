...
song2 = Song("Во поле береза стояла", BIRCH_NOTES, BIRCH_DURATION, (20, 220, 360, 45), interval=0.7)
song3 = Song("Утро", MORNING_NOTES, MORNING_DURATION, (20, 320, 360, 45))
...
while True:
    ...
    if mode == "menu":
        ...
        for song in Song.songs:
            ...
            screen.blit(song.text, (30, 109 * y + 5))
            y += 1
